...
var getAttr = function getAttr(node) {
  ...
  if (node && node.getAttributeNames) {
    ...
    map = attrNames.reduce(function (acc, key) {
...
/**
 * 将属性转化为字符串
 * @param  {Object} attrs   [要转化的map对象] 
 * @param  {Array}  exclude [要排除的key数组]
 * @return {[type]}         [转化后的字符串]
 */
var attr2Str = function attr2Str() {
  ...
  for (var _i = 0, _Object$entries = Object.entries(attrs); _i < _Object$entries.length; _i++) {
    ...
    if (!exclude.includes(key)) {
      list.push("".concat(key, "=\"").concat(value, "\""));
    }
  }
  return list.join(' ');
};

var RetryScript = /*#__PURE__*/function () {
  function RetryScript(options) {
    var _this = this;
    _classCallCheck(this, RetryScript);
    ...
    this._verifi(options).then(function (res) {
      _this.hosts = options.hosts || [];
      _this.handler = options.handler;
      _this.retryTimes = {}; // 重试次数
  ...
  _createClass(RetryScript, [{
    ...
    key: "_verifi",
    value: function () {
      var _verifi2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(options) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return _context.abrupt("return", Promise.reject('hosts must be Array!'));
              case 2:
      ...
      function _verifi(_x) {
        return _verifi2.apply(this, arguments);
      }
      return _verifi;
    }() // 绑定事件
  }, {
    ...
    value: function handleEvent(event) {
      ...
      var attrs = getAttr(target);
      var src = attrs.src || '';
      var sources = src.split(/\//g);
      ...
      // 创建新的src
      var newSrc = this._handler({
        currentIndex: this.retryTimes[source],
        // 当前索引
        source: source,
        // 资源
        oldSrc: src,
      ...
      // 获取dom上的属性值
      var attrStr = attr2Str(attrs, ['src']);
      document.write("<script ".concat(attrStr, " src=\"").concat(newSrc, "\"></script>"));
    }
  }, {
    key: "destory",
    ...
    key: "_handler",
    value: function _handler(config) {
      var newSrc;
